...
const CustomCursor = ()=>{
    ...
    const [cursorState, setCursorState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        position: {
            x: 0,
            y: 0
        },
    ...
    const currentPosition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        x: 0,
        y: 0
    });
    const animationId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(undefined);
    ...
    const animate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CustomCursor.useCallback[animate]": ()=>{
            ...
            const lerp = {
                "CustomCursor.useCallback[animate].lerp": (start, end, factor)=>start + (end - start) * factor
            }["CustomCursor.useCallback[animate].lerp"];
        ...
        "CustomCursor.useEffect": ()=>{
            ...
            const handleMouseDown = {
                "CustomCursor.useEffect.handleMouseDown": ()=>{
                    setCursorState({
                        "CustomCursor.useEffect.handleMouseDown": (prev)=>({
                                ...prev,
                                isClicking: true
                            })
                    }["CustomCursor.useEffect.handleMouseDown"]);
            ...
            const handleMouseUp = {
                "CustomCursor.useEffect.handleMouseUp": ()=>{
                    setCursorState({
                        "CustomCursor.useEffect.handleMouseUp": (prev)=>({
                                ...prev,
                                isClicking: false
                            })
                    }["CustomCursor.useEffect.handleMouseUp"]);
            ...
            const handleMouseEnter = {
                "CustomCursor.useEffect.handleMouseEnter": ()=>{
                    setCursorState({
                        "CustomCursor.useEffect.handleMouseEnter": (prev)=>({
                                ...prev,
                                isVisible: true
                            })
                    }["CustomCursor.useEffect.handleMouseEnter"]);
            ...
            const handleMouseLeave = {
                "CustomCursor.useEffect.handleMouseLeave": ()=>{
                    setCursorState({
                        "CustomCursor.useEffect.handleMouseLeave": (prev)=>({
                                ...prev,
                                isVisible: false
                            })
                    }["CustomCursor.useEffect.handleMouseLeave"]);
            ...
            const handleMouseOver = {
                "CustomCursor.useEffect.handleMouseOver": (e)=>{
                    ...
                    let hoverTarget = 'default';
                    // Check for project cards first (highest priority)
                    if (target.closest('[data-project-card]') || target.closest('.project-card')) {
                        hoverTarget = 'project';
                    } else if (target.tagName.toLowerCase() === 'a' || target.closest('a') || target.closest('[href]') || target.closest('nav a') || target.closest('.nav-link') || target.closest('[data-nav-link]') || // Next.js Link component detection
                    target.closest('[data-nextjs-link]') || target.closest('nav') && (target.tagName.toLowerCase() === 'span' || target.tagName.toLowerCase() === 'div') || // Check for elements with href attribute
                    target.getAttribute('href') || target.closest('header') && target.classList.contains('cursor-pointer') || // Check for menu items
                    target.closest('[role="menuitem"]') || target.closest('.menu-item')) {
                        hoverTarget = 'link';
                    } else if (target.tagName.toLowerCase() === 'button' || target.closest('button') || target.closest('[role="button"]') || target.classList.contains('btn') || target.classList.contains('button') || target.getAttribute('type') === 'button' || target.getAttribute('type') === 'submit' || target.closest('[data-button]') || target.closest('.cursor-pointer') && (target.textContent?.toLowerCase().includes('click') || target.textContent?.toLowerCase().includes('submit') || target.textContent?.toLowerCase().includes('send') || target.textContent?.toLowerCase().includes('view') || target.getAttribute('aria-label')?.toLowerCase().includes('button'))) {
                        hoverTarget = 'button';
                    } else if (target.tagName.toLowerCase() === 'input' || target.tagName.toLowerCase() === 'textarea' || target.contentEditable === 'true') {
                        hoverTarget = 'text';
                    }
                    setCursorState({
                        "CustomCursor.useEffect.handleMouseOver": (prev)=>({
                                ...prev,
                                hoverTarget
                            })
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            cursorState.hoverTarget !== 'default' && cursorState.isVisible && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                style: {
                    position: 'fixed',
...
_s(CustomCursor, "/+WQA/jAefNkKjgKEqkIQKiKxoo=");
_c = CustomCursor;
...
"[project]/src/components/ParallaxWrapper.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$scroll$2d$parallax$2f$dist$2f$react$2d$scroll$2d$parallax$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ParallaxProvider"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$CustomCursor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/src/components/ParallaxWrapper.tsx",
                lineNumber: 14,
                columnNumber: 7
            }, this),
            children
...
//# sourceMappingURL=_622bdc02._.js.map