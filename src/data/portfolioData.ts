...
export const projects: Project[] = [
  {
    ...
    tags: [
      { name: "AI", color: "linear-gradient(90deg, #8E2DE2 0%, #4A00E0 100%)" },
      { name: "LangChain", color: "linear-gradient(90deg, #fc466b 0%, #3f5efb 100%)" },
      { name: "NLP", color: "linear-gradient(90deg, #00c6ff 0%, #0072ff 100%)" },
      { name: "Automation", color: "linear-gradient(90deg, #ff9966 0%, #ff5e62 100%)" },
    ],
    imageUrl: '/images/project/linkedin_agent.png',
    galleryImages: [
      { url: '/images/project/linkedin_agent.png', alt: 'LinkedIn Agent Dashboard' },
    ],
    sourceCodeLink: '#',
    liveLink: '#',
  },
  {
    ...
    tags: [
      { name: "Llama3", color: "linear-gradient(90deg, #d53369 0%, #daae51 100%)" },
      { name: "LangChain", color: "linear-gradient(90deg, #fc466b 0%, #3f5efb 100%)" },
      { name: "AI", color: "linear-gradient(90deg, #8E2DE2 0%, #4A00E0 100%)" },
      { name: "CRM", color: "linear-gradient(90deg, #00C9FF 0%, #92FE9D 100%)" },
      { name: "API Integration", color: "linear-gradient(90deg, #f7971e 0%, #ffd200 100%)" },
    ],
    imageUrl: '/images/project/email_agent.png',
    galleryImages: [
      { url: '/images/project/email_agent.png', alt: 'Email Agent Workflow' },
    ],
    sourceCodeLink: '#',
    liveLink: '#',
  },
