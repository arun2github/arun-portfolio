      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent">
            Projects by Arun Dev Studio
          </h1>
          <p className="text-xl text-neutral-400 max-w-2xl mx-auto">
            A collection of our work in AI agents, mobile app development, and web applications — built by Arun Dev Studio for startups and enterprises worldwide
          </p>
        </div>
