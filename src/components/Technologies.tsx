...
const Technologies = () => {
  ...
  return (
    <section id="technologies" className="py-20 md:py-32 bg-[#0D0F14] overflow-hidden">
      ...
      {/* Row 1 — scrolls left */}
      <div className="marquee-wrapper mx-auto overflow-hidden mb-4" style={{ width: '80%', maskImage: 'linear-gradient(90deg, transparent 0%, black 10%, black 90%, transparent 100%)' }}>
      ...
      {/* Row 2 — scrolls right */}
      <div className="marquee-wrapper mx-auto overflow-hidden" style={{ width: '80%', maskImage: 'linear-gradient(90deg, transparent 0%, black 10%, black 90%, transparent 100%)' }}>
