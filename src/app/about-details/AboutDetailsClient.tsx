      ...
      >
        ...
        >
          ...
          {profile.codingJourney && (
            <Section title="My Evolution & Expertise" icon={<Rocket size={30} />} delay={0.1 * 1.5}>
          ...
          <Section title="Proven Results & Impact" icon={<Award size={30} />} delay={0.1 * 4}>
            <ul className="list-none space-y-4">
              {profile.achievements.map((ach, i) => (
                ...
                >
                  <GitBranch size={22} className="text-[#7E8CE0] mr-4 mt-1 flex-shrink-0 transform rotate-[-45deg]" />
        ...
        {/* Grouping What Drives Me and My Philosophy into a 2-column layout */}
        <motion.div 
          className="md:grid md:grid-cols-2 md:gap-10"
        >
          {profile.motivation && (
          ...
          {profile.philosophy && (
            <Section title="My Development Philosophy" icon={<BookOpen size={30} className="text-green-300" />} delay={0.1 * 5.5}>
...
export default AboutDetailsClient;